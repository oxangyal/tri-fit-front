...
const Home = () => {
    ...
    return (
        ...
        >
            ...
            <div style={{ zIndex: 3 }}>
                <div className="text-white md:text-3xl lg:text-5xl ml-auto mt-20 font-bold font-nunito">
                ...
                <button
                    className="bg-blue-500 text-white text-2xl font-bold py-4 px-8 rounded-full font-nunito"
                    style={buttonStyles}
                >
